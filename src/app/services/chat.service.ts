...
export class ChatService {
  ...
  getChatByFirstUserNameAndSecondUserName(firstUserName: String, secondUserName: String) {
    return this.httpClient.get<Chat[]>(this.baseUrl + "/chats/getChatByFirstUserNameAndSecondUserName" +
      '?firstUserName=' + firstUserName + '&secondUserName=' + secondUserName)
  }
  ...
  getLastMessage(firstUserName: string, secondUserName: string) {
    return this.httpClient.get<Message>(this.baseUrl + "/chats/lastmessage" +
      '?firstUserName=' + firstUserName + '&secondUserName=' + secondUserName)
  }
}
